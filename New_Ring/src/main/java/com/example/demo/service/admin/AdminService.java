...
public class AdminService extends UserService {
    ...
    public void update(EmployeeUpdateRequest employeeUpdateRequest) {
        Employee employee;
        employee = setUpdate(employeeUpdateRequest);

        if (employeeUpdateRequest.isAuthority() == true) employee.setAdmin(true);
        else if (employeeUpdateRequest.isAuthority() == false) employee.setAdmin(false);
